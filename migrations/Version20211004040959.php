 ...
 */
final class Version20211004040959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__budget AS SELECT id, category_id, item_id, value, description, detais FROM budget');
        $this->addSql('DROP TABLE budget');
        $this->addSql('CREATE TABLE budget (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, item_id INTEGER NOT NULL, value DOUBLE PRECISION NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, details CLOB DEFAULT NULL, CONSTRAINT FK_73F2F77B12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_73F2F77B126F525E FOREIGN KEY (item_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO budget (id, category_id, item_id, value, description, details) SELECT id, category_id, item_id, value, description, detais FROM __temp__budget');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE budget');
        $this->addSql('CREATE TABLE budget (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, item_id INTEGER NOT NULL, value DOUBLE PRECISION NOT NULL, description VARCHAR(255) DEFAULT NULL, detais CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO budget (id, category_id, item_id, value, description, detais) SELECT id, category_id, item_id, value, description, details FROM __temp__budget');
        $this->addSql('DROP TABLE __temp__budget');
        $this->addSql('CREATE INDEX IDX_73F2F77B12469DE2 ON budget (category_id)');
        $this->addSql('CREATE INDEX IDX_73F2F77B126F525E ON budget (item_id)');
        $this->addSql('DROP INDEX IDX_1F1B251E12469DE2');
