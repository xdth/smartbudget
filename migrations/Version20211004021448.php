 ...
 */
final class Version20211004021448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__plan AS SELECT id, category_id, item_id, value, description, details FROM "plan"');
        $this->addSql('DROP TABLE "plan"');
        $this->addSql('CREATE TABLE "plan" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, item_id INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, details CLOB DEFAULT NULL COLLATE BINARY, value DOUBLE PRECISION NOT NULL, CONSTRAINT FK_DD5A5B7D12469DE2 FOREIGN KEY (category_id) REFERENCES category (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DD5A5B7D126F525E FOREIGN KEY (item_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "plan" (id, category_id, item_id, value, description, details) SELECT id, category_id, item_id, value, description, details FROM __temp__plan');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__plan AS SELECT id, category_id, item_id, value, description, details FROM "plan"');
        $this->addSql('DROP TABLE "plan"');
        $this->addSql('CREATE TABLE "plan" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, item_id INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL, details CLOB DEFAULT NULL, value DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO "plan" (id, category_id, item_id, value, description, details) SELECT id, category_id, item_id, value, description, details FROM __temp__plan');
        $this->addSql('DROP TABLE __temp__plan');
        $this->addSql('CREATE INDEX IDX_DD5A5B7D12469DE2 ON "plan" (category_id)');
        $this->addSql('CREATE INDEX IDX_DD5A5B7D126F525E ON "plan" (item_id)');
