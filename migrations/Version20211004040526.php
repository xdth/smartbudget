 ...
 */
final class Version20211004040526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE budget (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, item_id INTEGER NOT NULL, value DOUBLE PRECISION NOT NULL, description VARCHAR(255) DEFAULT NULL, detais CLOB DEFAULT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "plan" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, item_id INTEGER NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, details CLOB DEFAULT NULL COLLATE BINARY, value DOUBLE PRECISION NOT NULL)');
